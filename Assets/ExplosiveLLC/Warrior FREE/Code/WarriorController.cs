...
namespace WarriorAnimsFREE
{
	public class WarriorController:SuperStateMachine
	{
		...
		[HideInInspector] public WarriorAnims.WarriorInputSystemController warriorInputSystemController;
		...
		private void Awake()
		{
			...
			if (warriorInputController != null) {
				...
				warriorInputSystemController = GetComponent<WarriorAnims.WarriorInputSystemController>();
